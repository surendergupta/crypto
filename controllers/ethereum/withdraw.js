...
module.exports.withdraw_eth = async function (req,res) {    
    try 
    {
        console.log("*** WITHDRAW ETH COIN ***");
        let owner_pk = process.env.OWNER_ETH_PRIVATE_KEY;
...
module.exports.withdraw_usdt_erc20 = async function (req,res) {
    try
    {
